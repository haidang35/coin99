...
export class Register extends Form {
  ...
  onSignup = async () => {
    ...
    if (this._isFormValid()) {
      const { FullName, Email, Birthday, PhoneNumber, Password, ConfirmationPassword } = this.state.form;
      const data = {
                                ...
                                <div className="form-group">
                                  ...
                                  <div className="controls">
                                    <input
                                      ...
                                      required value={Birthday.value} onChange={(ev) => this._setValue(ev, "Birthday")}
                                    />
                                    {Birthday.err !== "" ? (
                                      Birthday.err === "*" ? (
                                        <ErrorForm
                                ...
                                <div className="form-group">
                                  ...
                                  <div className="controls">
                                    <input
                                      ...
                                      required value={Email.value} onChange={(ev) => this._setValue(ev, "Email")}
                                    />
                                    {
                                ...
                                <div className="form-group">
                                  ...
                                  <div className="controls">
                                    <input
                                      ...
                                      required value={PhoneNumber.value} onChange={(ev) => this._setValue(ev, "PhoneNumber")}
                                      pattern={REGEX_TEL}
                                    />
                                    {PhoneNumber.err !== "" ? (
                                      PhoneNumber.err === "*" ? (
                                ...
                                <div className="form-group">
                                  ...
                                  <div className="controls">
                                    <input
                                      ...
                                      required value={Password.value} onChange={(ev) => this._setValue(ev, "Password")}
                                    />
                                    {Password.err !== "" ? (
                                      Password.err === "*" ? (
                                        <ErrorForm
                                ...
                                <div className="form-group">
                                  ...
                                  <div className="controls">
                                    <input
                                      ...
                                      required value={ConfirmationPassword.value} onChange={(ev) => this._setValue(ev, "ConfirmationPassword")}
                                    />
                                    {ConfirmationPassword.err !== "" ? (
                                      ConfirmationPassword.err === "*" ? (
                                        <ErrorForm
                                          message={"ConfirmationPassword cannot be empty"}
                                        />
                                      ) : (
