                  ...
                  <div className="col-lg-6 col-xs-12">
                    <div className="r1_graph1 db_box db_box_large has-shadow2 mt-15">
                      <div className="promp-box text-center">
                        <img
                          src="../data/crypto-dash/crypto-wallet.png"
                          alt=""
                        />
                        <h4 className="boldy mt-20 mb-10">
                          Start crypto trading Today
                        </h4>
                        <p>
                          Lorem ipsum dolor sit amet, Eveniet magni sit
                          explicabo Quo nihil atque.
                        </p>
                    ...
                    <div className="ask-box active">
                      ...
                      <div className="ask-info">
                        ...
                        <p className="g2-text mb-0">
                          lorem ipsum dolor sit elit. Perferendis veniam
                          exercitationem ducimus magni distinctio sit explicabo.
                        </p>
                      </div>
                                ...
                                <td>
                                  ...
                                  <div className="designer-info">
                                    ...
                                    <small className="text-muted">
                                      <span className="mr-10">11-26</span>{" "}
                                      10:23:45
                                    </small>
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  ...
                                  <div className="designer-info">
                                    <h6>Sell Record</h6>
                                    <small className="text-muted">
                                      <span className="mr-10">11-25</span>{" "}
                                      12:53:25
                                    </small>
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  ...
                                  <div className="designer-info">
                                    ...
                                    <small className="text-muted">
                                      <span className="mr-10">11-24</span>{" "}
                                      04:03:25
                                    </small>
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  ...
                                  <div className="designer-info">
                                    <h6>Buy Record</h6>
                                    <small className="text-muted">
                                      <span className="mr-10">11-22</span>{" "}
                                      09:33:02
                                    </small>
                                  </div>
                                </td>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  <div className="round img2">
                                    <img
                                      src="../data/crypto-dash/coin2.png"
                                      alt=""
                                    />
                                  </div>
                                  <div className="designer-info">
                              ...
                              <tr>
                                <td>
                                  <div className="round img2">
                                    <img
                                      src="../data/crypto-dash/coin4.png"
                                      alt=""
                                    />
                                  </div>
                                  <div className="designer-info">
                              ...
                              <tr>
                                <td>
                                  <div className="round img2">
                                    <img
                                      src="../data/crypto-dash/coin5.png"
                                      alt=""
                                    />
                                  </div>
                                  <div className="designer-info">
