                            ...
                            <div className="col-sm-12 col-md-8 col-md-offset-2">
                                <div className="form-content">
                                    <form className="form-horizontal">
                                        ...
                                        <div className="form-group">
                                            <label className="col-sm-4 control-label">Sell Amount</label>
                                            <div className="col-sm-8">
                                                <input
                                                    type="text"
                                        ...
                                        <div className="row">
                                            <div className="col-sm-8 col-sm-offset-4">
                                                <h3 className="form-title">Rate:</h3>
                                        ...
                                        <div className="form-group">
                                            <label className="col-sm-4 control-label">Your Wallet ID</label>
                                            <div className="col-sm-8">
                                                <input
                                                    type="text"
                                                    className="form-control input-solid"
                                        ...
                                        <div className="row">
                                            <div className="col-sm-offset-4 col-sm-8">
                                                <h3 className="form-title">How do you receive money:</h3>
                                            </div>
                                        </div>
                                        <div className="form-group">
                                            <label className="col-sm-4 control-label">
                                        ...
                                        <div className="form-group">
                                            <label className="col-sm-4 control-label">Account Info</label>
                                            <div className="col-sm-8">
                                                <textarea
                                                    className="form-control input-solid"
                                                    rows={5}
                                        ...
                                        <div className="form-group">
                                            <div className="col-sm-offset-4 col-sm-8">
                                                <button type="submit" className="btn btn-default mr-10">
                                                    Buy
                                                </button>
