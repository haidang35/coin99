                                    ...
                                    >
                                        ...
                                        <tbody>
                                            <tr data-href="price.html">
                                                ...
                                                <td>
                                                    <span className="value_overflow">Information Technology</span>
                                                </td>
                                                <td>
                                                    <span className="value_d1_return percent_positive">
                                                        +13.08%
                                            ...
                                            <tr data-href="price.html">
                                                <td>
                                                    <div className="logo-name">
                                                        ...
                                                        <span className="item_name_value">Alphabet Inc.</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr data-href="price.html">
                                                ...
                                                <td>
                                                    <span className="value_overflow">Consumer Discretionary</span>
                                                </td>
                                                <td>
                                                    <span className="value_d1_return percent_positive">
                                                        +43.04%
