          ...
          <div className="container">
            <div className="attr-nav">
              {currentUser == '' || currentUser == null ? (
                <ul>
                  <li>
                    <Link to="/signin" className="btn nav-btn" style={{ background:"#6251fc", fontSize:"15px"}}>
                      Login
                    </Link>
                  </li>
                  <li>
                    <Link to="/signup" className="btn nav-btn btn-orange" style={{fontSize:"14px"}}>
                      Sign Up
                    </Link>
                  </li>
                </ul>
            ...
            <div className="navbar-header">
              ...
              <a className="navbar-brand" href="/" style={{ marginTop: '-16px' }}>
                <img src="https://i.ibb.co/bNLWkY1/Logo.png" className="logo" alt="" />
              </a>
            </div>
